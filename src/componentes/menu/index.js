...
export function Menu() {
    ...
    return (
        <body className=" h-10 bg-zinc-200 fixed w-full z-50">
                ...
                <ul id="menu" className="list-none hidden flex-col  items-start top-0 right-0 h-screen w-64 z-50 bg-cinzaOpacity shadow-navSidebar backdrop-blur-[10px] fixed ">
                    ...
                    <li className=" h-12 w-full">
                        <Link
                            ...
                            className=" h-12 w-full px-8 decoration-none flex items-center decoration-black hover:bg-zinc-300 font-boldwhitespace-nowrap font-bold  text-2xl cursor-pointer"
                        >Quem somos</Link></li>
            ...
            <nav className="bg-zinc-200 shadow-nav3 hidden sm:flex w-full h-10 fixed z-50 ">
                ...
                <ul className=" hidden sm:flex w-full list-none justify-start items-center">
                    ...
                    <img
                        src={Gif} alt="logo"
                        className=" w-20 h-20 top-0 mt-0 opacity-70 flex"
                    />

                    <p className=" h-12 px-10 decoration-none flex items-center decoration-black whitespace-nowrap font-bold"
                    >Oficina Mecânica <span className=" text-vermelho"> Mack Car</span></p>
            ...
            <button onClick={openMenu}
                className=" sm:hidden flex px-4 py-2 z-50 justify-end items-end w-full"
            >
                <svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px" fill="black"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z" /></svg>
            </button>
